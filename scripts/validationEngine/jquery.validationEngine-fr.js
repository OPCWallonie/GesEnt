            ...
            $.validationEngineLanguage.allRules = {
               ...
               "minSize": {
                ...
                "phone": {
                    ...
                    "alertText": "* Numéro de t&eacute;l&eacute;phone invalide"
                },
                "email": {
                ...
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* Aucun caract&egrave;re sp&eacute;cial n'est accept&eacute;"
                },
				// --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
				"onlyLetterNumberSp": { // Avec caractere accentue
                    "regex": /^[0-9a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF\ \']+$/,
                    "alertText": "* Aucun caract&egrave;re sp&eacute;cial n'est accept&eacute;"
                },
				"ajaxUserCall": {
