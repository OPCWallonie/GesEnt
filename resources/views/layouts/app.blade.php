...
<div class="flex h-screen overflow-hidden">
    ...
    <aside x-show="sidebarOpen"
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto text-sm">
            ...
            {{-- Personnel --}}
            <div class="pt-3 pb-1 px-3 text-xs font-semibold uppercase tracking-wider text-slate-500">Personnel</div>
            ...
            <a href="{{ route('absences-collectives.index') }}"
               class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('absences-collectives.*') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            ...
            <a href="{{ route('charges-fonctionnement.index') }}"
               class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('charges-fonctionnement.*') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
