<x-app-layout>
    ...
    <form method="GET" class="mb-4 flex gap-3 flex-wrap">
        <input type="text" name="q" value="{{ request('q') }}"
               ...
               class="flex-1 min-w-48 rounded-lg border-gray-300 shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">
        <select name="statut" class="rounded-lg border-gray-300 shadow-sm text-sm focus:ring-blue-500 focus:border-blue-500">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                @forelse($chantiers as $chantier)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <x-badge :statut="$chantier->statut"/>
                        </td>
